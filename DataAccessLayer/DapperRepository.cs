...
namespace DataAccessLayer
{
    ...
    public class DapperRepository<T> : IRepository<T> where T : Car, IDomainObject, new()
    {
        ...
        public void Add(T t)
        {
            ...
            {
                string sqlQuery = "INSERT INTO Students (Brand, \"Color\", Year) " +
                      "VALUES (@Brand, @Color, @Year) RETURNING Id";
